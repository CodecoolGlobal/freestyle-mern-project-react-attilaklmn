...
const Filter = (props) => {
  return (
    <div className="filters">
      <form className="filter-form" onSubmit={props.onFilter}>
        ...
        <div className="input-column">
          ...
          ></input>
          <select className="filter-input-field" type="text" name="attack">
          ...
          <select className="filter-input-field" type="text" name="type">
            <option value="">All</option>
          ...
          <select className="filter-input-field" type="text" name="cardClass">
            <option value="">All</option>
        ...
        <div className="input-column">
          ...
          <select className="filter-input-field" type="text" name="health">
            <option value="">All</option>
            <option value="0">0</option>
            <option value="1">1</option>
            <option value="2">2</option>
          ...
          <select className="filter-input-field" type="text" name="rarity">
            <option value="">All</option>
          ...
          <select className="filter-input-field" type="text" name="cardSetId">
            <option value="">All</option>
